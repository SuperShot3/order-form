...
💰 Total Amount Received: ${order.items_total ?? ''} THB
...
function templatePaymentRequest(order) {
  const total = parseFloat(order.items_total) || 0;
...
(Includes delivery fee: ${order.delivery_fee ?? '0'} THB)
    ...
    <div>
      ...
      <div className="messages-layout">
        ...
        <div className="template-section">
          ...
          {!canPaymentRequest && (
            <p className="warning">Requires Total Amount Received and delivery fee (or 0)</p>
          )}
